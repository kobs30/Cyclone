...
export const CyclSymbolColored: FC<BrandIconProps> = ({ width, height, className }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <defs>
        <linearGradient x1="19.719%" y1="12.206%" x2="65.703%" y2="91.967%" id="rt3xm6zh7a">
          ...
          <stop stopColor="#52FA54" offset="71.379%" />
